...
#java -Xmx1G -cp $DIR/target/test-classes/:$DIR/../hoodie-client/target/test-classes/:${HADOOP_CONF_DIR}:$HOODIE_JAR:${CLIENT_JAR}:$OTHER_JARS KudiScalaApp "$@"
#echo "DIR IS" $DIR
#echo "HADOOP_CONF_DIR IS" $HADOOP_CONF_DIR
#echo "HOODIE_JAR IS" $HOODIE_JAR
#echo "CLIENT_JAR IS" $CLIENT_JAR
echo "OTHER_JARS IS" $OTHER_JARS
